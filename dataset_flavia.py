...
save_images(original_directory = 'train_original', save_directory='train', augment=True)
save_images(original_directory = 'test_original', save_directory='test', augment=False)
print('\n[DONE]')
